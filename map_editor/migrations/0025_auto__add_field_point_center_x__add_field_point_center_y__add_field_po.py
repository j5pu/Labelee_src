...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Point.center_x'
        db.add_column(u'map_editor_point', 'center_x',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Point.center_y'
        db.add_column(u'map_editor_point', 'center_y',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Point.isVertical'
        db.add_column(u'map_editor_point', 'isVertical',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Point.center_x'
        db.delete_column(u'map_editor_point', 'center_x')

        # Deleting field 'Point.center_y'
        db.delete_column(u'map_editor_point', 'center_y')

        # Deleting field 'Point.isVertical'
