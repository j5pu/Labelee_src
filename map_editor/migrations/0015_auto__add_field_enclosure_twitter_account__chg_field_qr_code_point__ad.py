...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enclosure.twitter_account'
        db.add_column(u'map_editor_enclosure', 'twitter_account',
                      self.gf('django.db.models.fields.CharField')(max_length=60, unique=True, null=True, blank=True),
                      keep_default=False)


        # Changing field 'QR_Code.point'
        db.alter_column(u'map_editor_qr_code', 'point_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['map_editor.Point']))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Enclosure.twitter_account'
        db.delete_column(u'map_editor_enclosure', 'twitter_account')


        # Changing field 'QR_Code.point'
        db.alter_column(u'map_editor_qr_code', 'point_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['map_editor.Point']))
