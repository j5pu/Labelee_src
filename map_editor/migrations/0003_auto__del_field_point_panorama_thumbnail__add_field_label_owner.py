...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'map_editor_label', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='owner', null=True, to=orm['map_editor.CustomUser']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'map_editor_label', 'owner_id')
    ...
    models = {
        ...
        u'map_editor.label': {
            ...
            'owner': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'owner'", 'null': 'True', 'to': u"orm['map_editor.CustomUser']"})
        },
