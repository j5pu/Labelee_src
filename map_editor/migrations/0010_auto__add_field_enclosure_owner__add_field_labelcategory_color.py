...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Enclosure.owner'
        db.add_column(u'map_editor_enclosure', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='enclosures', to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'LabelCategory.color'
        db.add_column(u'map_editor_labelcategory', 'color',
                      self.gf('django.db.models.fields.CharField')(default='black', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Enclosure.owner'
        db.delete_column(u'map_editor_enclosure', 'owner_id')

        # Deleting field 'LabelCategory.color'
        db.delete_column(u'map_editor_labelcategory', 'color')
