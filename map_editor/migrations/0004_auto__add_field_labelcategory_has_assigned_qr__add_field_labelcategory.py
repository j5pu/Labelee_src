...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabelCategory.has_assigned_qr'
        db.add_column(u'map_editor_labelcategory', 'has_assigned_qr',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'LabelCategory.is_connector'
        db.add_column(u'map_editor_labelcategory', 'is_connector',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'LabelCategory.is_visible_menu'
        db.add_column(u'map_editor_labelcategory', 'is_visible_menu',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'LabelCategory.is_visible_by_default'
        db.add_column(u'map_editor_labelcategory', 'is_visible_by_default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'LabelCategory.is_dashboard_category'
        db.add_column(u'map_editor_labelcategory', 'is_dashboard_category',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'LabelCategory.can_have_coupon'
        db.add_column(u'map_editor_labelcategory', 'can_have_coupon',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabelCategory.has_assigned_qr'
        db.delete_column(u'map_editor_labelcategory', 'has_assigned_qr')

        # Deleting field 'LabelCategory.is_connector'
        db.delete_column(u'map_editor_labelcategory', 'is_connector')

        # Deleting field 'LabelCategory.is_visible_menu'
        db.delete_column(u'map_editor_labelcategory', 'is_visible_menu')

        # Deleting field 'LabelCategory.is_visible_by_default'
        db.delete_column(u'map_editor_labelcategory', 'is_visible_by_default')

        # Deleting field 'LabelCategory.is_dashboard_category'
        db.delete_column(u'map_editor_labelcategory', 'is_dashboard_category')

        # Deleting field 'LabelCategory.can_have_coupon'
        db.delete_column(u'map_editor_labelcategory', 'can_have_coupon')
