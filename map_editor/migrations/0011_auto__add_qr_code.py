...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'map_editor_qr_code', (
            ...
            ('point', self.gf('django.db.models.fields.related.ForeignKey')(related_name='qr_code', to=orm['map_editor.Point'])),
        ))
    ...
    models = {
        ...
        u'map_editor.qr_code': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'qr_code'", 'to': u"orm['map_editor.Point']"})
        }
    }
