...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Label.name_es'
        db.add_column(u'map_editor_label', 'name_es',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Label.name_en'
        db.add_column(u'map_editor_label', 'name_en',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Label.name_es'
        db.delete_column(u'map_editor_label', 'name_es')

        # Deleting field 'Label.name_en'
        db.delete_column(u'map_editor_label', 'name_en')
