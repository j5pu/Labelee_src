...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LabelCategory.icon'
        db.add_column(u'map_editor_labelcategory', 'icon',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LabelCategory.icon'
        db.delete_column(u'map_editor_labelcategory', 'icon')
