...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Floor.num_cols'
        db.alter_column(u'map_editor_floor', 'num_cols', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Floor.num_rows'
        db.alter_column(u'map_editor_floor', 'num_rows', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Floor.num_cols'
        db.alter_column(u'map_editor_floor', 'num_cols', self.gf('django.db.models.fields.PositiveIntegerField')(default=1))

        # Changing field 'Floor.num_rows'
        db.alter_column(u'map_editor_floor', 'num_rows', self.gf('django.db.models.fields.PositiveIntegerField')(default=1))
    ...
    models = {
        ...
        u'map_editor.floor': {
            ...
            'num_cols': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'num_rows': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'})
        },
        u'map_editor.label': {
