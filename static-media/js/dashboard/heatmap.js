    ...
    legend.prototype = {
        init: function(){
            ...
            if(position.indexOf('t') > -1){
                positionCss += 'top:'+offset+'em;';
            }else{
                positionCss += 'bottom:'+offset+'em;';
            }

            // left or right
            if(position.indexOf('l') > -1){
                positionCss += 'left:'+offset+'em;';
            }else{
                positionCss += 'right:'+offset+'em;';
            }

            element = document.createElement("div");
            element.style.cssText = "border-radius:5px;position:absolute;"+positionCss+"font-family:Helvetica; width:256em;z-index:10000000000; background:rgba(255,255,255,1);padding:10em;border:1em solid black;margin:0;";
            element.innerHTML = "<h3 style='padding:0;margin:0;text-align:center;font-size:16em;'>"+title+"</h3>";
            // create gradient in canvas
            labelsEl.style.cssText = "position:relative;font-size:12em;display:block;list-style:none;list-style-type:none;margin:0;height:15em;";
            

            // create gradient element
            gradient = document.createElement("div");
            gradient.style.cssText = ["position:relative;display:block;width:256em;height:15em;border-bottom:1em solid black; background-image:url(",me.createGradientImage(),");"].join("");
        ...
        update: function(max){
            ...
            for(var i = 0; i < gradient.length; i++){
                ...
                labelsHtml += '<li style="position:absolute;left:'+(((((1/(gradient.length-1)*i*256) || 0)) >> 0)-offset+.5)+'em">'+labelText+'</li>';
            }       
