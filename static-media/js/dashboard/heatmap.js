function ConversionPuntoX(numColumnas, cellx, w) {
...
function ConversionPuntoY(numFilas, celly, h) {
...
function setHeatMap(element, floorName, floorCols, floorRows) {

    if (stepsByFloor) {

        // heatmap configuration
        var heatmapArea = 'heatmapArea_' + floorName;
        document.getElementById(heatmapArea).setAttribute('style', 'width:' + element.width + 'px;');
        document.getElementById(heatmapArea).setAttribute('style', 'height:' + element.height + 'px;');
        var config = {
        ...
        var data = {
            ...
            data: [
               ...
               /* { x: ConversionPuntoX(columnas, 72, element.width), y: ConversionPuntoY(filas, 115, element.height), count: 50}*/
            ]
        };
