...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CategoryShot'
        db.create_table(u'dashboard_categoryshot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('userkey', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(related_name='category_shots', to=orm['map_editor.LabelCategory'])),
        ))
        db.send_create_signal(u'dashboard', ['CategoryShot'])


        # Changing field 'DisplayedRoutes.origin'
        db.alter_column(u'dashboard_displayedroutes', 'origin_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['map_editor.Point']))
        # Adding unique constraint on 'DisplayedRoutes', fields ['origin']
        db.create_unique(u'dashboard_displayedroutes', ['origin_id'])


        # Changing field 'DisplayedRoutes.date'
        db.alter_column(u'dashboard_displayedroutes', 'date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'DisplayedRoutes.destination'
        db.alter_column(u'dashboard_displayedroutes', 'destination_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['map_editor.Point']))
        # Adding unique constraint on 'DisplayedRoutes', fields ['destination']
        db.create_unique(u'dashboard_displayedroutes', ['destination_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DisplayedRoutes', fields ['destination']
        db.delete_unique(u'dashboard_displayedroutes', ['destination_id'])

        # Removing unique constraint on 'DisplayedRoutes', fields ['origin']
        db.delete_unique(u'dashboard_displayedroutes', ['origin_id'])

        # Deleting model 'CategoryShot'
        db.delete_table(u'dashboard_categoryshot')


        # Changing field 'DisplayedRoutes.origin'
        db.alter_column(u'dashboard_displayedroutes', 'origin_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map_editor.Point']))

        # Changing field 'DisplayedRoutes.date'
        db.alter_column(u'dashboard_displayedroutes', 'date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'DisplayedRoutes.destination'
        db.alter_column(u'dashboard_displayedroutes', 'destination_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['map_editor.Point']))
    ...
    models = {
        ...
        u'dashboard.categoryshot': {
            'Meta': {'object_name': 'CategoryShot'},
            'category': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'category_shots'", 'to': u"orm['map_editor.LabelCategory']"}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'userkey': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'dashboard.displayedroutes': {
            'Meta': {'object_name': 'DisplayedRoutes'},
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'destination': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'displayed_destination'", 'unique': 'True', 'to': u"orm['map_editor.Point']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origin': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'displayed_origin'", 'unique': 'True', 'to': u"orm['map_editor.Point']"})
        },
        u'dashboard.qr_shot': {
            'Meta': {'object_name': 'Qr_shot'},
            'date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'point': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'qr_shots'", 'to': u"orm['map_editor.Point']"})
        },
