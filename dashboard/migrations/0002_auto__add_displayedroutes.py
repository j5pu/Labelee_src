...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DisplayedRoutes'
        db.create_table(u'dashboard_displayedroutes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('origin', self.gf('django.db.models.fields.related.ForeignKey')(related_name='origin', to=orm['map_editor.Point'])),
            ('destination', self.gf('django.db.models.fields.related.ForeignKey')(related_name='destination', to=orm['map_editor.Point'])),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'dashboard', ['DisplayedRoutes'])


    def backwards(self, orm):
        # Deleting model 'DisplayedRoutes'
        db.delete_table(u'dashboard_displayedroutes')
    ...
    models = {
        ...
        u'dashboard.displayedroutes': {
            ...
            'destination': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'destination'", 'to': u"orm['map_editor.Point']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'origin': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'origin'", 'to': u"orm['map_editor.Point']"})
        },
        u'dashboard.qr_shot': {
